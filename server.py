...
def index():
    try:
        ...
        return "An error occurred while rendering the index page.", 500
...
def questions():
    try:
        ...
        logging.error(f"Error sending questions_corrected.json: {e}")
        return "An error occurred while fetching the questions file.", 500
